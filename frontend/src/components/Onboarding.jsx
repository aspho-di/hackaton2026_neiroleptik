...
const STEPS = [
  ...
  {
    icon: <div style={{ width: 44, height: 44, borderRadius: '50%', background: '#f0fdf4', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><IconCheck size={26} color="#4caf50" /></div>,
  ...
  {
    icon: <div style={{ width: 44, height: 44, borderRadius: '50%', background: '#eff6ff', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><IconBarChart size={26} color="#3b82f6" /></div>,
  ...
  {
    icon: <div style={{ width: 44, height: 44, borderRadius: '50%', background: '#f0fdf4', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><IconDroplets size={26} color="#4caf50" /></div>,
  ...
  {
    icon: <div style={{ width: 44, height: 44, borderRadius: '50%', background: '#fffbeb', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><IconBell size={26} color="#f59e0b" /></div>,
  ...
  {
    icon: <div style={{ width: 44, height: 44, borderRadius: '50%', background: '#fef2f2', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><IconCompare size={26} color="#ef4444" /></div>,
